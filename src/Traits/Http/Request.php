...
trait Request
{
     ...
     * @throws \Exception
     */
    public function method(string $method, ?array $parameters = [])
    {
        $this->curl = $this->curl ?: $this->initCurl();
        ...
        if (curl_error($this->curl)) {
            throw new \Exception('Litegram: cUrl Error:' . curl_errno($this->curl) . ' - ' . curl_error($this->curl));
        }
