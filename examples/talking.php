...
// default data take from update `message.text`
// u can pass ur text
// $bot->addModule(Talk::class, ['pass text here']);
$bot->addModule(Talk::class);
...
Talk::train([
    ...
    echo "You can buy coffee on our website.";
});
...
$bot->run(); // Bot will say: You can buy coffee on our website.